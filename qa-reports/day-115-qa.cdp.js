#!/usr/bin/env node
/**
 * Day 115 QA harness — Cycle 5 HARDEN Week Day 3: Edge Cases & Stress.
 *
 * Pure-CDP runner (ws@8.x, no puppeteer). Boot deps first with
 *   tools/cdp-launch.sh start
 * then run:
 *   NODE_PATH=/Users/openclaw/src/openclaw/node_modules node qa-reports/day-115-qa.cdp.js
 *
 ...
 *
 * Coverage (HARDEN Week Wednesday spec — Edge Cases & Stress):
